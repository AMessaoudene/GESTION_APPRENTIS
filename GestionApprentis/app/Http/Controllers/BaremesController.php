    ...
    public function index()
{
    ...
    public function store(Request $request)
    {
        ...
        $baremes->montantchiffres1_maitreapprentis = $request->tauxs1_maitreapprentis * $referencesalariaires->salairereference;
        ...
        $baremes->montantchiffres2_maitreapprentis = $request->tauxs2_maitreapprentis * $referencesalariaires->salairereference;
        ...
        $baremes->montantchiffres3_maitreapprentis = $request->tauxs3_maitreapprentis * $referencesalariaires->salairereference;
        ...
        $baremes->montantchiffres4_maitreapprentis = $request->tauxs4_maitreapprentis * $referencesalariaires->salairereference;
        ...
        $baremes->montantchiffres5_maitreapprentis = $request->tauxs5_maitreapprentis * $referencesalariaires->salairereference;
