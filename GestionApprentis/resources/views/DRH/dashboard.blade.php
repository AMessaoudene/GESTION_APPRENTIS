...
<div class="container mt-5 mb-5">
    <h1 class="text-center mb-5">Bienvenue sur DRH Dashboard</h1>
    ...
    <a href="#" class="custom-button">Gestion des parametres</a>
    <a href="#" class="custom-button">Gestion des présalaires et primes</a>
