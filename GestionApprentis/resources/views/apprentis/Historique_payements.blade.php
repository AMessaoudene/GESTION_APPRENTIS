                    ...
                    <tbody>
                        <tr>
                            ...
                            @foreach ($baremes as $bareme)
                                ...
                                @endif
                            @endforeach
                            <td>{{ $decision->datedebutpresalaireS1 }}</td>
                            <td>{{ $decision->datefinpresalaireS1 }}</td>
                            <td>{{ $decision->datedebutpresalaireS2 }}</td>
                            <td>{{ $decision->datefinpresalaireS2 }}</td>
                            <td>{{ $decision->datedebutpresalaireS3 }}</td>
                            <td>{{ $decision->datefinpresalaireS3 }}</td>
                            <td>{{ $decision->datedebutpresalaireS4 }}</td>
                            <td>{{ $decision->datefinpresalaireS4 }}</td>
                            <td>{{ $decision->datedebutpresalaireS5 }}</td>
                            <td>{{ $decision->datefinpresalaireS5 }}</td>
